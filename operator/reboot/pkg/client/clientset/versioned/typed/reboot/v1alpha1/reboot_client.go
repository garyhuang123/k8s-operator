...
// RebootV1alpha1Client is used to interact with features provided by the reboot group.
type RebootV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RebootV1alpha1Client) Reboots(namespace string) RebootInterface {
	return newReboots(c, namespace)
}
...
// NewForConfigOrDie creates a new RebootV1alpha1Client for the given config and
