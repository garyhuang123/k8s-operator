...
import (
	...
	reboot "k8s-operator/operator/reboot/pkg/client/informers/externalversions/reboot"
	reflect "reflect"
	sync "sync"
	time "time"
...
func (f *sharedInformerFactory) Reboot() reboot.Interface {
	return reboot.New(f, f.namespace, f.tweakListOptions)
}
